  ...
  if (profilEdit($nim, $nama, $prodi, $fakultas, $instansi, $telp)) {
    ...
    if (isset($_GET["nim_penyewa"])) {
        ...
        if ($data === null) {
            ...
            // Perbarui nilai variabel dengan data dari profil
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <div class="container col-md-6">
              <h1 class="mt-5 text-center">Profil Saya</h1>
              <form method="post" action="">
                    <!-- Nim -->
                  <div class="form-group">
                      <label for="nim_penyewa">NIM:</label>
                      <input type="text" class="form-control" name="nim_penyewa" value="<?php echo $_SESSION['nim_penyewa'];?>" disabled>
                  </div>
                  <div class="form-group">
                      <!-- Nama -->
                  <div class="form-group">
                      <label for="nama_penyewa">Nama</label>
                      <input type="text" class="form-control" name="nama_penyewa" value="<?php echo $_SESSION['nama_penyewa'];?>" disabled>
                  </div>
      
                  <!-- prodi -->
                  <div class="form-group">
                      <label for="prodi">Prodi:</label>
                      <input type="text" class="form-control" name="prodi" value="<?php echo $_SESSION['prodi'];?>" disabled>
                  </div>
                 <!-- fakultas --> 
                  <div class="form-group">
                      <label for="fakultas">Fakultas:</label>
                      <input type="text" class="form-control" name="fakultas" value="<?php echo $_SESSION['fakultas'];?>" disabled>
                  </div>
                  <!-- Nama instansi -->
                  <div class="form-group">
                      <label for="nama_instansi">Nama Instansi:</label>
                      <input type="text" class="form-control" name="nama_instansi" value="<?php echo $_SESSION['nama_instansi'];?>" disabled>
                  </div>
                  <!-- No telp -->
                  <div class="form-group">
                      <label for="no_telp">No Telfon:</label>
                      <input type="text" class="form-control" name="no_telp" value="<?php echo $_SESSION['no_telp'];?>" disabled>
                  </div>
                  <a href="profilEdit.php" class="btn btn-secondary mb-3">Edit Profil</a>
              </form>
      </div>
            <!-- Page Heading -->
        </div>
