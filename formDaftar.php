...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($penyewa) || empty($id_gazebo) || empty($id_ruangan) || empty($mulai_sewa) || empty($selesai_sewa) || empty($nama_kegiatan)) {
        ...
        $result = formDaftar($penyewa, $id_gazebo, $id_ruangan, $mulai_sewa, $selesai_sewa, $nama_kegiatan);

        if ($result['status'] === 'success') {
            $success_message = 'Peminjaman berhasil.';
            // Redirect atau lakukan tindakan lain setelah peminjaman berhasil
...
<html lang="en">
  <head>
    ...
    <title>SiPirang-FormPeminjaman</title>
    <!-- Favicon-->
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <div class="container col-md-6">
              <h1 class="mt-5 text-center">Form Peminjaman</h1>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                      ...
                      <input type="hidden" id="selectedGazeboValue" name="id_gazebo" required>
            </div>
            <div class="form-group">
                ...
                <div class="form-group">
                      ...
                      <!-- Hidden input field to store selected value -->
                      <input type="hidden" id="selectedRuanganValue" name="id_ruangan" required>
            </div>
            <script>
          ...
          function selectValue(value, type) {
            ...
            <div class="form-group">
                ...
                <input type="datetime-local" class="form-control" name="mulai_sewa" required>
            </div>
            <div class="form-group">
                <label for="selesai_sewa">Waktu Selesai Sewa:</label>
                <input type="datetime-local" class="form-control" name="selesai_sewa" required>
            </div>
            <div class="form-group">
